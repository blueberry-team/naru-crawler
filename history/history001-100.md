...
> 📊 MIXI 404 패턴 정리: `/recruitment-category/13482/` 404, `/recruitment-category/13557/` 404, `/recruitment-category/new-graduate/13517/` 404. 그러나 `/recruitment-category/new-graduate/13170/` 200, `/recruitment-category/new-graduate/13420/` 200. **같은 `/new-graduate/` 경로 내에서도 ID별 차이 있음**. 채용 종료된 개별 공고만 삭제되는 구조.