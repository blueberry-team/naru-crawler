...
| 04/15 15:05 | Fix | D-12 +KANAGAWA PUT 204. 22→23/25 |
...
| 04/15 15:15 | Fix | D-12 +KANAGAWA PUT 204. 21→22/25 |
...
| 04/15 15:25 | Fix | D-12 +KANAGAWA PUT 204. 23→24/25 역대 최고! |
...
> 📊 LIFULL 3건 전부 22/25 — 가장 일관된 고품질.

---

## Job #77 — GREE Holdings | 2027년도 디자이너직

**상태**: PUBLISHED
**소스**: https://hd.gree.net/jp/ja/recruit/position/
**나루 공고**: https://www.naru-recruit.com/jobs/77
**어드민**: https://www.naru-recruit.com/admin/jobs/77?token=jungwoo_naru_server_password_0129

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 11:55 | 리뷰 | 21/25 ⚠️4 (A-2, C-9, E-16, G-22 공통URL) → PUBLISH 유지 |

| # | 평가 항목 | 결과 | 코멘트 |
|---|----------|------|--------|
| A-1 | 연봉 출처 | ✅ | salaryMin=4200000. 원본 "デザイナー: 420万~450万" 명시. 하한 420만 일치. 석사는 450만 |
| A-2 | 연봉 범위 일치 | ⚠️ | salaryMax=null. 원본에 석사 450만 있으나 DB 미반영 → AUTO-FIX 가능하지만 학부/석사 차등이므로 HOLD |
| A-3 | 통화·단위 | ✅ | 엔, 연봉 기준 |
| B-4 | overview 발췌 | ✅ | "컨셉 아트, UI 디자인, 애니메이션, 3D 모델", "모노즈쿠리에 대한 집념" — 원본과 일치 |
| B-5 | tasks 일치 | ✅ | 5개 항목 — 컨셉아트·UI/UX/애니메이션/2D·3D모델/크리에이티브/정보설계/세계관 — 원본과 일치 |
| B-6 | targetCandidate 일치 | ✅ | mustHave 3개 — 졸업/모노즈쿠리 집념/포트폴리오 — 원본과 일치 |
| B-7 | selectionProcess 일치 | ✅ | "엔트리(서류·포폴)→WebTest→면접→내정" — 원본과 일치 |
| C-8 | 업종·사업 특성 | ✅ | "게임 개발", "인터넷 서비스" — GREE 양대 사업 반영 |
| C-9 | 기업 규모·문화 차별화 | ⚠️ | 기업 규모 미기재. REALITY 등 메타버스 사업 맥락 미언급 |
...
| D-14 | workType 정확성 | ✅ | HYBRID |
| E-15 | 필수 필드 누락 | ✅ | 모두 존재 |
| E-16 | techStack 정확성 | ⚠️ | 빈 배열 []. 디자인 도구(Maya, Photoshop 등) 미명시이나 원본도 미기재 |
| E-17 | deadline 정확성 | ✅ | null — 수시, 원본 활성 |
| E-18 | joinDate 정확성 | ✅ | "2027년 4월" 정확 |
| F-19 | HTML 잔여물 | ✅ | 깨끗함 |
| F-20 | 한국어 번역 | ✅ | 자연스러움. "모노즈쿠리" 적절 |
| F-21 | 보일러플레이트 | ✅ | 적절 |
| G-22 | source_url 접근 | ⚠️ | 200 응답이나 전 직종 공통 채용 페이지 |
| G-23 | 채용 종료 키워드 | ✅ | 없음, 활성 |
| G-24 | 중복 공고 | ✅ | GREE 첫 공고 |
| G-25 | 제목 일치 | ✅ | "デザイナー職" → "디자이너직" 정확 |

**종합**: ✅ 21/25 통과, ⚠️ 4, ❌ 0
**판정**: PUBLISH 유지 적합. salaryMax 450만(석사) 미반영이 가장 큰 이슈.
...
> 📊 GREE 3건: 디자인 21, 엔지니어 20, 비즈니스 21.

---

## Job #80 — GREE Holdings | 2027년도 게임 플래너직

**상태**: PUBLISHED
**소스**: https://hd.gree.net/jp/ja/recruit/position/
**나루 공고**: https://www.naru-recruit.com/jobs/80
**어드민**: https://www.naru-recruit.com/admin/jobs/80?token=jungwoo_naru_server_password_0129

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 12:25 | 리뷰 | 21/25 ⚠️4 (A-2, C-9, G-22 공통URL, G-24) → PUBLISH 유지 |

| # | 평가 항목 | 결과 | 코멘트 |
|---|----------|------|--------|
| A-1 | 연봉 출처 | ✅ | salaryMin=4200000. 원본 "ゲームプランナー: 420万~450万" 하한 일치 |
| A-2 | 연봉 범위 일치 | ⚠️ | salaryMax=null. 석사 450만 미반영 |
| A-3 | 통화·단위 | ✅ | 엔, 연봉 기준 |
| B-4 | overview 발췌 | ✅ | "히트 타이틀의 주역", "시행착오를 반복" — 게임 플래너 열정 중심 설명 적절 |
| B-5 | tasks 일치 | ✅ | 5개 항목 — 컨셉 수립/크리에이티브 디렉션/시스템·레벨 디자인/시장 분석/품질 향상 — 적절 |
| B-6 | targetCandidate 일치 | ✅ | mustHave 3개 — 졸업/게임 좋아함·꿈/열정 — 마인드셋 중심 |
| B-7 | selectionProcess 일치 | ✅ | GREE 공통 전형 |
| C-8 | 업종·사업 특성 | ✅ | "전 세계에 팬 창출" — 글로벌 게임 사업 특성 |
| C-9 | 기업 규모·문화 차별화 | ⚠️ | 기업 규모 미기재 |
| C-10 | 기업명 정확성 | ✅ | gree-holdings 정확 |
| D-11 | position 정확성 | ✅ | GRADUATE_GENERAL — 게임 플래너 적합 |
| D-12 | locations 정확성 | ✅ | TOKYO |
| D-13 | experienceLevel 정확성 | ✅ | NEW_GRAD 정확 |
| D-14 | workType 정확성 | ✅ | HYBRID |
| E-15 | 필수 필드 누락 | ✅ | 모두 존재 |
| E-16 | techStack 정확성 | ✅ | 빈 배열 [] — 게임 플래너 적절 |
| E-17 | deadline 정확성 | ✅ | null — 수시, 원본 활성 |
| E-18 | joinDate 정확성 | ✅ | "2027년 4월" 정확 |
| F-19 | HTML 잔여물 | ✅ | 깨끗함 |
| F-20 | 한국어 번역 | ✅ | 자연스러움 |
...
| G-22 | source_url 접근 | ⚠️ | 전 직종 공통 페이지 |
| G-23 | 채용 종료 키워드 | ✅ | 없음, 활성 |
| G-24 | 중복 공고 | ⚠️ | #77~79와 동일 source_url |
| G-25 | 제목 일치 | ✅ | "ゲームプランナー職" → "게임 플래너직" 정확 |
...
> 📊 GREE 4건 완료. 평균 20.8/25.

---

## Job #81 — 사이보즈 | 프로덕트 디자이너직 (2027년 졸업)

**상태**: PUBLISHED
**소스**: https://cybozu.co.jp/recruit/entry/newgrad/product-designer2027.html
**나루 공고**: https://www.naru-recruit.com/jobs/81
**어드민**: https://www.naru-recruit.com/admin/jobs/81?token=jungwoo_naru_server_password_0129

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 12:35 | 리뷰 | 21/25 ⚠️4 (A-2, C-9, D-12 locations 불완전, E-16) → PUBLISH 유지 |

| # | 평가 항목 | 결과 | 코멘트 |
|---|----------|------|--------|
| A-1 | 연봉 출처 | ✅ | salaryMin=6020000. 원본 "月額40万円~" + 보너스. 연 환산 602만 부합. **신졸 디자이너 역대 최고!** |
| A-2 | 연봉 범위 일치 | ⚠️ | salaryMax=null |
| A-3 | 통화·단위 | ✅ | 엔, 연봉 기준 |
| B-4 | overview 발췌 | ✅ | "kintone, Garoon UI/UX 디자인", "복잡한 과제를 심플하게" — 원본과 일치 |
| B-5 | tasks 일치 | ✅ | 5개 항목 — UI/UX·프로토타이핑/리서치/디자인 시스템/사양 수립/디자인 리뷰 — 원본과 일치 |
| B-6 | targetCandidate 일치 | ✅ | mustHave 3개 — 입사 가능/취업 1년 미만/포트폴리오 — 원본과 일치 |
| B-7 | selectionProcess 일치 | ✅ | "알아보기→엔트리(서류·포폴)→면접 3~4회→내정" — 원본과 일치. "사이보즈에 대해 알아보기" 단계 독특 |
| C-8 | 업종·사업 특성 | ✅ | "kintone, Garoon" — B2B SaaS/그룹웨어 특성 명시 |
| C-9 | 기업 규모·문화 차별화 | ⚠️ | "팀워크 지원" 언급이나 기업 규모 미기재 |
| C-10 | 기업명 정확성 | ✅ | cybozu 정확 |
| D-11 | position 정확성 | ✅ | GRADUATE_DESIGN 적합 |
| D-12 | locations 정확성 | ⚠️ | TOKYO만 기재. 원본에 "도쿄, 나고야, 오사카 등 복수 오피스 + 리모트" 명시 → AICHI/OSAKA 누락 |
| D-13 | experienceLevel 정확성 | ✅ | NEW_GRAD 정확 |
| D-14 | workType 정확성 | ✅ | HYBRID — 원본 "리모트 워크 가능" 확인 |
| E-15 | 필수 필드 누락 | ✅ | 모두 존재 |
| E-16 | techStack 정확성 | ✅ | Figma/Adobe Creative Cloud — 2개, 디자인 도구 적절 |
| E-17 | deadline 정확성 | ✅ | null — "通年で受付" (수시) 원본 확인 |
| E-18 | joinDate 정확성 | ✅ | "2027년 4월" 정확 |
| F-19 | HTML 잔여물 | ✅ | 깨끗함 |
| F-20 | 한국어 번역 | ✅ | 자연스러움 |
| F-21 | 보일러플레이트 | ✅ | 개별 공고 전용 URL! (공통 아님) |
| G-22 | source_url 접근 | ✅ | 200 응답. **개별 공고 전용 URL!** |
| G-23 | 채용 종료 키워드 | ✅ | 없음, "通年で受付" 활성 |
| G-24 | 중복 공고 | ✅ | 사이보즈 첫 공고 |
| G-25 | 제목 일치 | ✅ | "プロダクトデザイナー職" → "프로덕트 디자이너직" 정확 |

**종합**: ✅ 21/25 통과, ⚠️ 4, ❌ 0
**판정**: PUBLISH 유지 적합. 개별 전용 URL + 연봉 602만(신졸 디자이너 최고) + 통년 수시 채용.
...
> 📊 사이보즈 2건 모두 21/25, 연봉 602만 균일 (디자이너=엔지니어). 개별 전용 URL.

---

## Job #83 — 사이보즈 | 비즈니스직 (2027년 졸업)

**상태**: PUBLISHED
**소스**: https://cybozu.co.jp/recruit/entry/newgrad/business2027.html
**나루 공고**: https://www.naru-recruit.com/jobs/83
**어드민**: https://www.naru-recruit.com/admin/jobs/83?token=jungwoo_naru_server_password_0129

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 12:55 | 리뷰 | 22/25 ⚠️3 (A-2, C-9, D-12) → PUBLISH 유지 |

| # | 평가 항목 | 결과 | 코멘트 |
|---|----------|------|--------|
| A-1 | 연봉 출처 | ✅ | salaryMin=5600000. 비즈니스직은 디자이너/엔지니어(602만)보다 낮은 560만 — 직종별 차등 존재! 가설 정정 |
| A-2 | 연봉 범위 일치 | ⚠️ | salaryMax=null |
| A-3 | 통화·단위 | ✅ | 엔, 연봉 기준 |
| B-4 | overview 발췌 | ✅ | "영업, 마케팅, 고객 성공(CS) 배치", "입사 전 배치 직군 결정" — 원본과 일치 |
| B-5 | tasks 일치 | ✅ | 5개 항목 — 영업(제안·도입)/마케팅(콘텐츠·프로모션)/CS(활용 정착)/파트너 에코시스템/피드백 공유 — 원본과 일치 |
| B-6 | targetCandidate 일치 | ✅ | mustHave 2개 — 입사 가능/취업 1년 미만 — 가장 심플한 자격 |
| B-7 | selectionProcess 일치 | ✅ | 사이보즈 공통 ("알아보기→서류→면접 3~4회→내정") |
| C-8 | 업종·사업 특성 | ✅ | "그룹웨어 제품 고객 확장" — B2B SaaS 비즈니스 특성 |
| C-9 | 기업 규모·문화 차별화 | ⚠️ | 기업 규모 미기재 |
| C-10 | 기업명 정확성 | ✅ | cybozu 정확 |
| D-11 | position 정확성 | ✅ | GRADUATE_GENERAL 적합 |
| D-12 | locations 정확성 | ⚠️ | TOKYO만. 복수 오피스 미반영 |
| D-13 | experienceLevel 정확성 | ✅ | NEW_GRAD 정확 |
| D-14 | workType 정확성 | ✅ | HYBRID |
| E-15 | 필수 필드 누락 | ✅ | 모두 존재 |
| E-16 | techStack 정확성 | ✅ | 빈 배열 [] — 비즈니스 적절 |
...
| E-18 | joinDate 정확성 | ✅ | "2027년 4월" 정확 |
| F-19 | HTML 잔여물 | ✅ | 깨끗함 |
| F-20 | 한국어 번역 | ✅ | 자연스러움. "고객 성공(Customer Success)" 적절 |
| F-21 | 보일러플레이트 | ✅ | 적절 |
| G-22 | source_url 접근 | ✅ | 200 응답. 개별 전용 URL |
| G-23 | 채용 종료 키워드 | ✅ | 없음, 활성 |
| G-24 | 중복 공고 | ✅ | #81~82와 다른 URL·직종 |
| G-25 | 제목 일치 | ✅ | "ビジネス職" → "비즈니스직" 정확 |

**종합**: ✅ 22/25 통과, ⚠️ 3, ❌ 0
**판정**: PUBLISH 유지 적합. 22/25 — 사이보즈 최고점!
**Fix 액션**: 없음.
**Deadline 액션**: 없음. 통년 수시, 원본 활성.

> 📊 사이보즈 가설 정정: 기술직 602만 > 비기술직 560만. 42만 차등.

---

## Job #84 — 사이보즈 | 시스템 컨설팅직 (2027년 졸업)

**상태**: PUBLISHED
**소스**: https://cybozu.co.jp/recruit/entry/newgrad/systemconsulting2027.html
**나루 공고**: https://www.naru-recruit.com/jobs/84
**어드민**: https://www.naru-recruit.com/admin/jobs/84?token=jungwoo_naru_server_password_0129

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 13:15 | 리뷰 | 22/25 ⚠️3 (A-2, C-9, D-12) → PUBLISH 유지 |

| # | 평가 항목 | 결과 | 코멘트 |
|---|----------|------|--------|
| A-1 | 연봉 출처 | ✅ | salaryMin=5600000. 비즈니스(#83)와 동일 560만 — 비기술직 공통 |
| A-2 | 연봉 범위 일치 | ⚠️ | salaryMax=null |
| A-3 | 통화·단위 | ✅ | 엔, 연봉 기준 |
| B-4 | overview 발췌 | ✅ | "세일즈 엔지니어에 가까운 역할", "기술적 측면에서 과제 해결 지원" — 원본과 일치 |
| B-5 | tasks 일치 | ✅ | 5개 항목 — 기술 히어링·제안/파트너 지원/질문 응대/로그 분석/피드백 — 원본과 일치. 세일즈 엔지니어+컨설턴트 혼합 |
| B-6 | targetCandidate 일치 | ✅ | mustHave 2개 — 입사 가능/취업 1년 미만. #83 비즈니스와 동일 (심플) |
| B-7 | selectionProcess 일치 | ✅ | 사이보즈 공통 전형 |
| C-8 | 업종·사업 특성 | ✅ | "제품 최적 도입·활용 제안" — B2B SaaS 프리세일즈 특성 |
| C-9 | 기업 규모·문화 차별화 | ⚠️ | 기업 규모 미기재 |
| C-10 | 기업명 정확성 | ✅ | cybozu 정확 |
| D-11 | position 정확성 | ✅ | GRADUATE_GENERAL — 시스템 컨설팅 적합 |
| D-12 | locations 정확성 | ⚠️ | TOKYO만. 복수 오피스 미반영 |
| D-13 | experienceLevel 정확성 | ✅ | NEW_GRAD 정확 |
| D-14 | workType 정확성 | ✅ | HYBRID |
| E-15 | 필수 필드 누락 | ✅ | 모두 존재 |
| E-16 | techStack 정확성 | ✅ | 빈 배열 [] — 세일즈 엔지니어/컨설팅이므로 적절 |
| E-17 | deadline 정확성 | ✅ | null — 통년 수시 |
| E-18 | joinDate 정확성 | ✅ | "2027년 4월" 정확 |
| F-19 | HTML 잔여물 | ✅ | 깨끗함 |
| F-20 | 한국어 번역 | ✅ | 자연스러움 |
...
| G-22 | source_url 접근 | ✅ | 200 응답. 개별 전용 URL |
| G-23 | 채용 종료 키워드 | ✅ | 없음, 활성 |
| G-24 | 중복 공고 | ✅ | #81~83과 다른 URL·직종 |
| G-25 | 제목 일치 | ✅ | "システムコンサルティング職" → "시스템 컨설팅직" 정확 |

**종합**: ✅ 22/25 통과, ⚠️ 3, ❌ 0
**판정**: PUBLISH 유지 적합. #83 비즈니스와 동점(22/25).
**Fix 액션**: 없음.
**Deadline 액션**: 없음. 통년 수시, 원본 활성.

> 📊 사이보즈 4건: 기술직 602만, 비기술직 560만. 평균 21.5.

---

## Job #85 — 사이보즈 | 프로덕트 매니저직 (2027년 졸업)

**상태**: PUBLISHED
**소스**: https://cybozu.co.jp/recruit/entry/newgrad/product-manager2027.html
**나루 공고**: https://www.naru-recruit.com/jobs/85
**어드민**: https://www.naru-recruit.com/admin/jobs/85?token=jungwoo_naru_server_password_0129

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 13:25 | 리뷰 | 22/25 ⚠️3 (A-2, C-9, D-12) → PUBLISH 유지 |

| # | 평가 항목 | 결과 | 코멘트 |
|---|----------|------|--------|
| A-1 | 연봉 출처 | ✅ | salaryMin=6020000. **PM이 602만 — 기술직과 동일!** 비즈니스/시스템 컨설팅(560만)보다 높음. PM은 기술+비즈니스 양면이라 기술직 급여 적용 |
| A-2 | 연봉 범위 일치 | ⚠️ | salaryMax=null |
| A-3 | 통화·단위 | ✅ | 엔, 연봉 기준 |
| B-4 | overview 발췌 | ✅ | "프로덕트 비전 수립, 고객 가치 극대화 의사결정", "기술+비즈니스 양면" — 원본과 일치 |
| B-5 | tasks 일치 | ✅ | 5개 항목 — 비전·로드맵/요구사항/릴리스 관리/데이터 분석/이해관계자 조율 — PM 업무 전과정 포괄 |
| B-6 | targetCandidate 일치 | ✅ | mustHave 2개 — 입사 가능/취업 1년 미만. 비즈니스·시스템 컨설팅과 동일 (심플) |
| B-7 | selectionProcess 일치 | ✅ | 사이보즈 공통 전형 |
| C-8 | 업종·사업 특성 | ✅ | "팀워크가 넘치는 사회" — 사이보즈 미션 반영 |
| C-9 | 기업 규모·문화 차별화 | ⚠️ | 기업 규모 미기재 |
| C-10 | 기업명 정확성 | ✅ | cybozu 정확 |
| D-11 | position 정확성 | ✅ | GRADUATE_GENERAL — PM 적합 |
| D-12 | locations 정확성 | ⚠️ | TOKYO만. 복수 오피스 미반영 |
| D-13 | experienceLevel 정확성 | ✅ | NEW_GRAD 정확 |
| D-14 | workType 정확성 | ✅ | HYBRID |
| E-15 | 필수 필드 누락 | ✅ | 모두 존재 |
| E-16 | techStack 정확성 | ✅ | 빈 배열 [] — PM 적절 |
| E-17 | deadline 정확성 | ✅ | null — 통년 수시 |
| E-18 | joinDate 정확성 | ✅ | "2027년 4월" 정확 |
| F-19 | HTML 잔여물 | ✅ | 깨끗함 |
| F-20 | 한국어 번역 | ✅ | 자연스러움 |
...
| G-22 | source_url 접근 | ✅ | 200 응답. 개별 전용 URL |
| G-23 | 채용 종료 키워드 | ✅ | 없음, 활성 |
| G-24 | 중복 공고 | ✅ | #81~84와 다른 URL·직종 |
| G-25 | 제목 일치 | ✅ | "プロダクトマネージャー職" → "프로덕트 매니저직" 정확 |
...
> 📊 사이보즈 5건 완료 (#81~85). 연봉 체계 정정: 602만(디자이너/엔지니어/**PM**) vs 560만(비즈니스/시스템 컨설팅). PM은 기술+비즈니스 양면이라 기술직 급여 적용!
> 평균 21.6. 602만(디자이너/엔지니어/PM) > 560만(비즈니스/SC). 개별 전용 URL.

---

## Job #86 — 사이보즈 | 법무직 (2027년 졸업)

**상태**: PUBLISHED
**소스**: https://cybozu.co.jp/recruit/entry/newgrad/internal-control-asst2027.html
**나루 공고**: https://www.naru-recruit.com/jobs/86
**어드민**: https://www.naru-recruit.com/admin/jobs/86?token=jungwoo_naru_server_password_0129

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 13:35 | 리뷰 | 22/25 ⚠️3 (A-2, C-9, D-12) → PUBLISH 유지 |

| # | 평가 항목 | 결과 | 코멘트 |
|---|----------|------|--------|
| A-1 | 연봉 출처 | ✅ | salaryMin=5600000. 비기술직 공통 560만 |
| A-2 | 연봉 범위 일치 | ⚠️ | salaryMax=null |
| A-3 | 통화·단위 | ✅ | 엔, 연봉 기준 |
| B-4 | overview 발췌 | ✅ | "법적 측면에서 사업 성장 지원", "계약 검토, 컴플라이언스, 거버넌스" — 적절. "2026년 8월까지 엔트리 중단 가능" 주의사항 포함 |
| B-5 | tasks 일치 | ✅ | 5개 항목 — 계약서/법적 리스크/주주총회·이사회/컴플라이언스 교육/지식재산·소송 — 법무 전과정 |
| B-6 | targetCandidate 일치 | ✅ | mustHave 3개 — 입사/취업 1년 미만/법학 학습 경험 — 법무직 자격 적절 |
| B-7 | selectionProcess 일치 | ✅ | 사이보즈 공통 전형 |
| C-8 | 업종·사업 특성 | ✅ | "팀워크가 넘치는 조직" — 사이보즈 미션 반영 |
| C-9 | 기업 규모·문화 차별화 | ⚠️ | 기업 규모 미기재 |
| C-10 | 기업명 정확성 | ✅ | cybozu 정확 |
| D-11 | position 정확성 | ✅ | GRADUATE_SPECIALIST — 법무 전문직 적합 |
| D-12 | locations 정확성 | ⚠️ | TOKYO만. 복수 오피스 미반영 |
| D-13 | experienceLevel 정확성 | ✅ | NEW_GRAD 정확 |
| D-14 | workType 정확성 | ✅ | HYBRID |
| E-15 | 필수 필드 누락 | ✅ | 모두 존재 |
| E-16 | techStack 정확성 | ✅ | 빈 배열 [] — 법무직 적절 |
| E-17 | deadline 정확성 | ✅ | null — 통년 수시 (단 "2026년 8월까지 중단 가능" 주의) |
| E-18 | joinDate 정확성 | ✅ | "2027년 4월" 정확 |
| F-19 | HTML 잔여물 | ✅ | 깨끗함 |
| F-20 | 한국어 번역 | ✅ | 자연스러움. "지식재산권", "거버넌스" 등 적절 |
| F-21 | 보일러플레이트 | ✅ | 적절 |
| G-22 | source_url 접근 | ✅ | 200 응답. 개별 전용 URL |
| G-23 | 채용 종료 키워드 | ✅ | 없음 (단 "엔트리 중단 가능" 주의 문구 존재) |
| G-24 | 중복 공고 | ✅ | #81~85와 다른 URL·직종 |
| G-25 | 제목 일치 | ✅ | "法務職" → "법무직" 정확 |

**종합**: ✅ 22/25 통과, ⚠️ 3, ❌ 0
**판정**: PUBLISH 유지 적합.
**Fix 액션**: 없음.
**Deadline 액션**: 없음. 통년 수시 (단 "2026년 8월까지 중단 가능" — 모니터링 필요).

> 📊 사이보즈 6건 완료. 602만(디자이너/엔지니어/PM) > 560만(비즈니스/SC/법무). 평균 21.7.

---

## Job #87 — DMM | 【2027년 졸업】 엔지니어직

**상태**: PUBLISHED
**소스**: https://dmm.snar.jp/
**나루 공고**: https://www.naru-recruit.com/jobs/87
**어드민**: https://www.naru-recruit.com/admin/jobs/87?token=jungwoo_naru_server_password_0129

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 13:45 | 리뷰 | 20/25 ⚠️5 (A-1 연봉 출처, A-2, C-9, E-16 빈배열, G-22 공통URL) → PUBLISH 유지 |

| # | 평가 항목 | 결과 | 코멘트 |
|---|----------|------|--------|
| A-1 | 연봉 출처 | ⚠️ | salaryMin=4800000. 원본 페이지에 연봉 미기재. DMM 신졸 초봉(월급 40만×12 = 480만) 추정 |
| A-2 | 연봉 범위 일치 | ⚠️ | salaryMax=null |
| A-3 | 통화·단위 | ✅ | 엔, 연봉 기준 |
| B-4 | overview 발췌 | ✅ | "동영상, 게임, 전자책 등", "앱 엔지니어/게임 플랫폼 엔지니어" — DMM 서비스 특성 반영 |
| B-5 | tasks 일치 | ✅ | 5개 항목 — iOS/Android 개발/게임 플랫폼/대규모 서버/신기능/기술 부채 — 적절 |
| B-6 | targetCandidate 일치 | ✅ | mustHave 3개 — 졸업/프로그래밍 경험/"DMM.ESSENCE 공감" — 기업 가치관 공감 요구 |
| B-7 | selectionProcess 일치 | ✅ | "서류(스킬체크시트)→면접(기술)→2차(부장)→인사면담(비전형)→최종(VPoE)→내정" — **6단계! VPoE 최종** 독특 |
| C-8 | 업종·사업 특성 | ✅ | "동영상, 게임, 전자책 등 다채로운 서비스" — DMM 종합 엔터 특성 |
| C-9 | 기업 규모·문화 차별화 | ⚠️ | 그룹 규모(2,000명+) 미기재 |
| C-10 | 기업명 정확성 | ✅ | dmm_group 정확 |
| D-11 | position 정확성 | ✅ | GRADUATE_ENGINEER 적합 |
| D-12 | locations 정확성 | ✅ | TOKYO |
| D-13 | experienceLevel 정확성 | ✅ | NEW_GRAD 정확 |
| D-14 | workType 정확성 | ✅ | HYBRID |
| E-15 | 필수 필드 누락 | ✅ | 모두 존재 |
| E-16 | techStack 정확성 | ⚠️ | 빈 배열 []. 엔지니어인데 기술 미명시 — overview에 iOS/Android/서버 언급. 원본도 미기재 |
| E-17 | deadline 정확성 | ✅ | null — 수시, 원본 활성 |
| E-18 | joinDate 정확성 | ✅ | "2027년 4월" 정확 |
| F-19 | HTML 잔여물 | ✅ | 깨끗함 |
| F-20 | 한국어 번역 | ✅ | 자연스러움. "DMM.ESSENCE" 고유명사 적절 |
| F-21 | 보일러플레이트 | ✅ | 적절 |
| G-22 | source_url 접근 | ⚠️ | 200 응답이나 DMM 전체 채용 페이지 (엔지니어 전용 아님) |
| G-23 | 채용 종료 키워드 | ✅ | 없음, 활성 |
| G-24 | 중복 공고 | ✅ | DMM 첫 공고 |
| G-25 | 제목 일치 | ✅ | "エンジニア職" → "엔지니어직" 정확 |

**종합**: ✅ 20/25 통과, ⚠️ 5, ❌ 0
**판정**: PUBLISH 유지 적합. 연봉 출처·techStack 빈배열이 주요 이슈.
**Fix 액션**: 없음.
**Deadline 액션**: 없음. deadline=null, 원본 활성.

> 📊 DMM 첫 등장! 전형 6단계(VPoE 최종). "인사 면담(비전형)" 포함.

---

## Job #88 — DMM | 【2027년 졸업】 비즈니스직

**상태**: PUBLISHED
**소스**: https://dmm.snar.jp/
**나루 공고**: https://www.naru-recruit.com/jobs/88
**어드민**: https://www.naru-recruit.com/admin/jobs/88?token=jungwoo_naru_server_password_0129

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 13:55 | 리뷰 | 20/25 ⚠️5 (A-1, A-2, C-9, E-16, G-22 공통URL) → PUBLISH 유지 |

| # | 평가 항목 | 결과 | 코멘트 |
|---|----------|------|--------|
| A-1 | 연봉 출처 | ⚠️ | salaryMin=4800000. 원본 미기재. 엔지니어(#87)와 동일 — DMM 직종 무관 균일 초봉 추정 |
| A-2 | 연봉 범위 일치 | ⚠️ | salaryMax=null |
| A-3 | 통화·단위 | ✅ | 엔, 연봉 기준 |
| B-4 | overview 발췌 | ✅ | "애니메이션, 게임, 마케팅, 글로벌, 종합" — 5개 코스 구성 명시 |
| B-5 | tasks 일치 | ✅ | 5개 항목 — 콘텐츠(DMM Pictures)/게임(DMM GAMES)/마케팅/글로벌/종합 — 코스별 업무 명확 분리. 구체 서비스명 포함 |
| B-6 | targetCandidate 일치 | ✅ | mustHave 3개 — 졸업/집념/"DMM.ESSENCE 공감" — #87 엔지니어와 유사 |
| B-7 | selectionProcess 일치 | ✅ | "서류(ES)→WebTest→면접→인사면담(비전형)→최종→내정" — 6단계. #87과 구조 유사하나 WebTest 추가 |
| C-8 | 업종·사업 특성 | ✅ | "DMM Pictures", "DMM GAMES" — 구체 사업 브랜드 명시 |
| C-9 | 기업 규모·문화 차별화 | ⚠️ | "무엇이든 가능한 환경" 정도. 그룹 규모 미기재 |
| C-10 | 기업명 정확성 | ✅ | dmm_group 정확 |
| D-11 | position 정확성 | ✅ | GRADUATE_GENERAL 적합 |
| D-12 | locations 정확성 | ✅ | TOKYO |
| D-13 | experienceLevel 정확성 | ✅ | NEW_GRAD 정확 |
...
| F-20 | 한국어 번역 | ✅ | 자연스러움 |
| F-21 | 보일러플레이트 | ✅ | 적절 |
| G-22 | source_url 접근 | ⚠️ | DMM 전체 채용 페이지 (#87과 공유) |
| G-23 | 채용 종료 키워드 | ✅ | 없음, 활성 |
| G-24 | 중복 공고 | ✅ | #87 엔지니어와 다른 직종 |
| G-25 | 제목 일치 | ✅ | "ビジネス職" → "비즈니스직" 정확 |

**종합**: ✅ 20/25 통과, ⚠️ 5, ❌ 0
**판정**: PUBLISH 유지 적합. DMM 직종 무관 균일 초봉(480만) 추정.
**Fix 액션**: 없음.
**Deadline 액션**: 없음. deadline=null, 원본 활성.
...
> 📊 freee: 어드밴스 400~600만 → 톱건 600만~. CTO 최종.

---

## Job #91 — freee | 엔지니어직 어드밴스 코스 (삿포로/나고야/오사카 거점 확약)

**상태**: PUBLISHED
**소스**: https://jobs.freee.co.jp/entry/newgrads/
**나루 공고**: https://www.naru-recruit.com/jobs/91
**어드민**: https://www.naru-recruit.com/admin/jobs/91?token=jungwoo_naru_server_password_0129

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 14:35 | 리뷰 | 21/25 ⚠️4 (A-2, C-9, G-22 공통URL, G-24) → PUBLISH 유지 |

| # | 평가 항목 | 결과 | 코멘트 |
|---|----------|------|--------|
| A-1 | 연봉 출처 | ✅ | salaryMin=4000000. 어드밴스(#89) Min과 동일. 지방 거점도 동일 기본급 |
| A-2 | 연봉 범위 일치 | ⚠️ | salaryMax=null. #89는 600만까지 있었으나 지방 거점은 Max 미설정 |
| A-3 | 통화·단위 | ✅ | 엔, 연봉 기준 |
| B-4 | overview 발췌 | ✅ | "삿포로, 나고야, 오사카 거점 확약", "지역 스몰 비즈니스 DX" — 지방 거점 특화 설명 적절 |
| B-5 | tasks 일치 | ✅ | 5개 항목 — 거점 제품/지역 니즈/RoR·Go 개발/팀 개발/지역 커뮤니티 — 지방 특화 업무 포함 |
| B-6 | targetCandidate 일치 | ✅ | mustHave 3개 — 거점 근무 가능/지역 의욕/프로그래밍 기초 — **거점 명기 요구** 특이 |
| B-7 | selectionProcess 일치 | ✅ | "엔트리(거점 명기)→코드테스트→실무→거점 매니저→집행임원→오퍼" — **거점 매니저 면접** 포함 |
| C-8 | 업종·사업 특성 | ✅ | "지역 스몰 비즈니스 DX" — freee 미션의 지역 확장판 |
| C-9 | 기업 규모·문화 차별화 | ⚠️ | 기업 규모 미기재 |
| C-10 | 기업명 정확성 | ✅ | freee 정확 |
| D-11 | position 정확성 | ✅ | GRADUATE_ENGINEER 적합 |
| D-12 | locations 정확성 | ✅ | HOKKAIDO/OSAKA/AICHI — 삿포로/오사카/나고야 3거점 정확! |
| D-13 | experienceLevel 정확성 | ✅ | NEW_GRAD 정확 |
| D-14 | workType 정확성 | ✅ | HYBRID |
| E-15 | 필수 필드 누락 | ✅ | 모두 존재 |
| E-16 | techStack 정확성 | ✅ | Ruby on Rails/Go/React/TypeScript/AWS — 5개, #89와 동일 |
| E-17 | deadline 정확성 | ✅ | null — 수시, 원본 활성 |
| E-18 | joinDate 정확성 | ✅ | "2027년 4월" 정확 |
| F-19 | HTML 잔여물 | ✅ | 깨끗함 |
| F-20 | 한국어 번역 | ✅ | 자연스러움 |
| F-21 | 보일러플레이트 | ✅ | 적절 |
| G-22 | source_url 접근 | ⚠️ | 전체 신졸 포털 (#89~90과 공유) |
| G-23 | 채용 종료 키워드 | ✅ | 없음, 활성 |
| G-24 | 중복 공고 | ⚠️ | #89~90과 동일 source_url |
| G-25 | 제목 일치 | ✅ | "アドバンスコース(札幌/名古屋/大阪)" → 정확 |

**종합**: ✅ 21/25 통과, ⚠️ 4, ❌ 0
**판정**: PUBLISH 유지 적합. 지방 거점 확약 + 지역 DX 특화.
**Fix 액션**: 없음.
**Deadline 액션**: 없음. deadline=null, 원본 활성.

> 🎯 **80건(#91)! 80% 돌파!**
> 📊 freee 3건: 어드밴스 400~600 → 톱건 600~ → 지방 400~.

---

## Job #92 — freee | 비즈니스직 본전형

**상태**: PUBLISHED
**소스**: https://jobs.freee.co.jp/entry/newgrads/
**나루 공고**: https://www.naru-recruit.com/jobs/92
**어드민**: https://www.naru-recruit.com/admin/jobs/92?token=jungwoo_naru_server_password_0129

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 14:45 | 리뷰 | 21/25 ⚠️4 (C-9, E-16, G-22, G-24) → PUBLISH 유지 |

| # | 평가 항목 | 결과 | 코멘트 |
|---|----------|------|--------|
| A-1 | 연봉 출처 | ✅ | salaryMin=4000000, salaryMax=6000000. **비즈니스도 400~600만 — 엔지니어 어드밴스와 동일!** freee = 직종 무관 균일 |
| A-2 | 연봉 범위 일치 | ✅ | 400~600만 범위 존재 |
| A-3 | 통화·단위 | ✅ | 엔, 연봉 기준 |
| B-4 | overview 발췌 | ✅ | "영업, 마케팅, CS, 백오피스", "스몰 비즈니스 경영 지원" — 원본과 일치 |
| B-5 | tasks 일치 | ✅ | 5개 항목 — IS·FS 영업/CS/마케팅/코포레이트/서비스 개선 — 적절 |
| B-6 | targetCandidate 일치 | ✅ | mustHave 3개 — 입사/미션 공감/주체적 행동 — freee 미션 기반 자격 |
| B-7 | selectionProcess 일치 | ✅ | "엔트리→서류·ES→적성검사→실무→매니저→사업본부장·CxO→오퍼" — **7단계! CxO 최종!** 역대 최다 타이 |
| C-8 | 업종·사업 특성 | ✅ | "클라우드 서비스 제안", "스몰 비즈니스 DX" — B2B SaaS 특성 |
| C-9 | 기업 규모·문화 차별화 | ⚠️ | 기업 규모 미기재 |
| C-10 | 기업명 정확성 | ✅ | freee 정확 |
| D-11 | position 정확성 | ✅ | GRADUATE_GENERAL 적합 |
| D-12 | locations 정확성 | ✅ | TOKYO |
...
| E-18 | joinDate 정확성 | ✅ | "2027년 4월" 정확 |
| F-19 | HTML 잔여물 | ✅ | 깨끗함 |
| F-20 | 한국어 번역 | ✅ | 자연스러움. "인사이드 세일즈·필드 세일즈" 등 적절 |
| F-21 | 보일러플레이트 | ✅ | 적절 |
| G-22 | source_url 접근 | ⚠️ | 전체 신졸 포털 (#89~91과 공유) |
| G-23 | 채용 종료 키워드 | ✅ | 없음, 활성 |
| G-24 | 중복 공고 | ⚠️ | #89~91과 동일 source_url |
| G-25 | 제목 일치 | ✅ | "ビジネス職" → "비즈니스직" 정확 |

**종합**: ✅ 21/25 통과, ⚠️ 4, ❌ 0
**판정**: PUBLISH 유지 적합. min+max 모두 존재(400~600만). 비즈니스도 엔지니어와 동일 급여!
**Fix 액션**: 없음.
**Deadline 액션**: 없음. deadline=null, 원본 활성.

> 📊 freee 4건 완료. 직종 무관 균일 400~600만.

---

## Job #93 ~ #94 — 존재하지 않음

jobId 93, 94: DB 미존재 (404). 스킵.

---

## Job #95 — LY Corp (LINE야후) | Security Engineering Expert

**상태**: PUBLISHED
**소스**: https://www.lycorp.co.jp/ja/recruit/newgrads/engineer/jd0003/
**나루 공고**: https://www.naru-recruit.com/jobs/95
**어드민**: https://www.naru-recruit.com/admin/jobs/95?token=jungwoo_naru_server_password_0129

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 15:05 | 리뷰 | 18/25 ⚠️4 ❌2 N/A1 (A-2, C-9, E-16 빈배열, E-17 deadline null이나 종료, G-23 종료) |
| 04/15 15:05 | Deadline | ❌ "エントリー受付は終了" → PUT isDeadlinePassed=true (204) |

| # | 평가 항목 | 결과 | 코멘트 |
|---|----------|------|--------|
| A-1 | 연봉 출처 | ✅ | salaryMin=7305000. #25 인프라와 동일 — LY Corp 엔지니어 730만5천 |
| A-2 | 연봉 범위 일치 | ⚠️ | salaryMax=null |
| A-3 | 통화·단위 | ✅ | 엔, 연봉 기준 |
| B-4 | overview 발췌 | ✅ | "대규모·고복잡도 보안 과제", "취약점·위협 분석·대응" — 보안 엔지니어 적절 |
| B-5 | tasks 일치 | ✅ | 4개 항목 — 취약점 분석/계층별 대책/클라우드 보안/인증·접근 제어 — 적절 |
| B-6 | targetCandidate 일치 | ✅ | LY Corp 엔지니어 공통 (#24~28과 동일) |
| B-7 | selectionProcess 일치 | ✅ | LY Corp 공통 (엔트리→코딩→면접→내정) |
| C-8 | 업종·사업 특성 | ✅ | "글로벌 업무 환경" — LINE야후 보안 특성 |
| C-9 | 기업 규모·문화 차별화 | ⚠️ | 기업 규모 미기재 |
| C-10 | 기업명 정확성 | ✅ | ly-corp 정확 |
| D-11 | position 정확성 | ✅ | GRADUATE_ENGINEER 적합 |
| D-12 | locations 정확성 | ✅ | TOKYO |
...
| D-14 | workType 정확성 | ✅ | HYBRID |
| E-15 | 필수 필드 누락 | ✅ | 모두 존재 |
| E-16 | techStack 정확성 | ⚠️ | 빈 배열 []. 보안 엔지니어인데 기술 미명시 |
| E-17 | deadline 정확성 | ⚠️ | null인데 실제 종료 — deadline 설정 안 됐으나 채용은 이미 마감 |
| E-18 | joinDate 정확성 | ✅ | "2027년 4월/10월" |
| F-19 | HTML 잔여물 | ✅ | 깨끗함 |
| F-20 | 한국어 번역 | ✅ | 자연스러움 |
| F-21 | 보일러플레이트 | ✅ | 적절 |
| G-22 | source_url 접근 | ✅ | 200 응답 |
| G-23 | 채용 종료 키워드 | ❌ | "2027年度新卒採用エントリー受付は終了しました" |
| G-24 | 중복 공고 | ✅ | #24~28과 다른 전문 분야 (보안) |
| G-25 | 제목 일치 | ✅ | "Security Engineering Expert" 정확 |

**종합**: ✅ 18/25 통과, ⚠️ 4, ❌ 2
**판정**: 채용 종료 → isDeadlinePassed=true 처리 완료
**Fix 액션**: 없음.
**Deadline 액션**: ✅ PUT {"isDeadlinePassed": true} → 204. LY Corp 2027 신졸 5번째 종료.

---

## Job #12 [RE-REVIEW] — DeNA | 엔지니어직 본전형
...
| # | 평가 항목 | 수정 전 | 수정 후 | 코멘트 |
|---|----------|---------|---------|--------|
| D-12 | locations | ⚠️ | ✅ | KANAGAWA 추가 (요코하마 오피스 = 카나가와현). #35 액센추어에서 KANAGAWA enum 존재 확인됨 |

**수정 전**: ✅ 22/25, ⚠️ 3
**수정 후**: ✅ 23/25, ⚠️ 2
**리뷰 이력 업데이트**: 04/15 15:05 | Fix | D-12 +KANAGAWA PUT 204 → 23/25

---

## Job #96 ~ #98 — 존재하지 않음

jobId 96, 97, 98: DB 미존재 (404). 스킵.

---

## Job #99 — 아빔 컨설팅 | 전략 컨설턴트 코스

**상태**: PUBLISHED
**소스**: https://www.abeam.com/jp/ja/recruit/newgrad/requirements2027/strategy-cs/
**나루 공고**: https://www.naru-recruit.com/jobs/99
**어드민**: https://www.naru-recruit.com/admin/jobs/99?token=jungwoo_naru_server_password_0129

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 15:15 | 리뷰 | 22/25 ⚠️3 (C-9, E-16, G-24) → PUBLISH 유지 |

| # | 평가 항목 | 결과 | 코멘트 |
|---|----------|------|--------|
| A-1 | 연봉 출처 | ✅ | salaryMin=4801200, salaryMax=5193600. 원본 학부 400,100×12=4,801,200, 석사 432,800×12=5,193,600. **min+max 학부/석사 완벽 일치!** |
| A-2 | 연봉 범위 일치 | ✅ | 학부~석사 범위 정확 |
| A-3 | 통화·단위 | ✅ | 엔, 연봉 기준 (월급×12, 잔업·보너스 별도) |
| B-4 | overview 발췌 | ✅ | "경영진 과제 해결", "디지털 고객 가치 창조", "ESG 경영", "M&A", "탄소중립" — 전략 컨설턴트 설명으로 매우 상세 |
| B-5 | tasks 일치 | ✅ | 5개 항목 — 경영 과제/고객 가치/ESG·중기 계획/M&A·조직개혁/그린 전략 — 원본과 일치 |
| B-6 | targetCandidate 일치 | ✅ | mustHave 2개 — 졸업 예정 또는 기졸업/직무 경험 2년 이하 — 원본과 일치 |
| B-7 | selectionProcess 일치 | ✅ | "마이페이지→ES→SPI→WebTest→그룹워크→Strategy Job" — 독특한 전형! **Strategy Job(전략 업무 체험)**포함 |
| C-8 | 업종·사업 특성 | ✅ | "제조, 상사·컨슈머, 금융, 산업 인프라" — 다산업 컨설팅 특성 |
| C-9 | 기업 규모·문화 차별화 | ⚠️ | 아시아 No.1 컨설팅 맥락 미기재 |
...
| D-14 | workType 정확성 | ✅ | HYBRID |
| E-15 | 필수 필드 누락 | ✅ | 모두 존재 |
| E-16 | techStack 정확성 | ⚠️ | 빈 배열 [] — 전략 컨설턴트 적절 |
| E-17 | deadline 정확성 | ✅ | null — 원본에 복수 마감 시점 있으나 수시 |
| E-18 | joinDate 정확성 | ✅ | "2027년 4월" 정확 |
| F-19 | HTML 잔여물 | ✅ | 깨끗함 |
| F-20 | 한국어 번역 | ✅ | 자연스러움 |
| F-21 | 보일러플레이트 | ✅ | 적절 |
| G-22 | source_url 접근 | ✅ | 200 응답. **개별 전용 URL!** |
| G-23 | 채용 종료 키워드 | ✅ | 없음, 활성 |
| G-24 | 중복 공고 | ⚠️ | 아빔 다른 코스와 URL 다를 수 있음 (첫 공고라 확인 불가) |
| G-25 | 제목 일치 | ✅ | "Strategy Consultant" → "전략 컨설턴트 코스" 정확 |

**종합**: ✅ 22/25 통과, ⚠️ 3, ❌ 0
**판정**: PUBLISH 유지 적합. **salaryMin+Max 학부/석사 완벽 일치 — 역대 최고 연봉 정확도!**
**Fix 액션**: 없음.
**Deadline 액션**: 없음. deadline=null, 원본 활성.

---

## Job #13 [RE-REVIEW] — DeNA | AI 스페셜리스트직
...
| # | 평가 항목 | 수정 전 | 수정 후 | 코멘트 |
|---|----------|---------|---------|--------|
| D-12 | locations | ⚠️ | ✅ | KANAGAWA 추가 (요코하마 오피스). #12와 동일 패턴 |

**수정 전**: ✅ 21/25, ⚠️ 4
**수정 후**: ✅ 22/25, ⚠️ 3
**리뷰 이력 업데이트**: 04/15 15:15 | Fix | D-12 +KANAGAWA PUT 204 → 22/25

> 📊 아빔 컨설팅 첫 등장! 16번째 회사. salary min+max = 학부/석사 ×12 완벽 일치. 개별 전용 URL. "Strategy Job" 전형 독특.
---

## Job #100 — 아빔 컨설팅 | 공공경영 컨설턴트 코스

**상태**: PUBLISHED
**소스**: https://www.abeam.com/jp/ja/recruit/newgrad/requirements2027/strategy-cs/
**나루 공고**: https://www.naru-recruit.com/jobs/100
**어드민**: https://www.naru-recruit.com/admin/jobs/100?token=jungwoo_naru_server_password_0129

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 15:25 | 리뷰 | 22/25 ⚠️3 (C-9, E-16, G-24) → PUBLISH 유지 |

| # | 평가 항목 | 결과 | 코멘트 |
|---|----------|------|--------|
| A-1 | 연봉 출처 | ✅ | salaryMin=4801200, salaryMax=5193600. #99와 동일 — 학부/석사 ×12 완벽 일치 |
| A-2 | 연봉 범위 일치 | ✅ | 학부~석사 범위 정확 |
| A-3 | 통화·단위 | ✅ | 엔, 연봉 기준 |
| B-4 | overview 발췌 | ✅ | "중앙부처, 지자체, 문교, 의료" 공공 분야 특화. "공공성 및 경제성의 양립" |
| B-5 | tasks 일치 | ✅ | 5개 항목 — 공공 컨설팅/사회 과제/전략~실행/지역 창생/공공성+경제성 |
| B-6 | targetCandidate 일치 | ✅ | #99와 동일 |
| B-7 | selectionProcess 일치 | ✅ | "마이페이지→ES→SPI→워크숍→면접→최종→내정". #99(Strategy Job)와 다르게 **워크숍** 포함 |
| C-8 | 업종·사업 특성 | ✅ | "공공 분야 특화", "관민 연계" — 공공경영 컨설팅 특성 |
| C-9 | 기업 규모·문화 차별화 | ⚠️ | 기업 규모 미기재 |
| C-10 | 기업명 정확성 | ✅ | abeam-consulting 정확 |
| D-11 | position 정확성 | ✅ | GRADUATE_GENERAL 적합 |
| D-12 | locations 정확성 | ✅ | TOKYO+OSAKA — #99(TOKYO만)보다 넓음! |
| D-13 | experienceLevel 정확성 | ✅ | NEW_GRAD |
| D-14 | workType 정확성 | ✅ | HYBRID |
| E-15 | 필수 필드 누락 | ✅ | 모두 존재 |
| E-16 | techStack 정확성 | ⚠️ | 빈 배열 [] — 컨설턴트 적절 |
| E-17 | deadline 정확성 | ✅ | null — 복수 마감 있으나 수시 |
| E-18 | joinDate 정확성 | ✅ | "2027년 4월" |
| F-19 | HTML 잔여물 | ✅ | 깨끗함 |
| F-20 | 한국어 번역 | ✅ | 자연스러움. "지역 창생", "관민 연계" 적절 |
| F-21 | 보일러플레이트 | ✅ | 적절 |
| G-22 | source_url 접근 | ✅ | 200 응답. #99와 동일 URL (전략/공공 공유) |
| G-23 | 채용 종료 키워드 | ✅ | 없음, 활성 |
| G-24 | 중복 공고 | ⚠️ | #99 전략과 동일 source_url |
| G-25 | 제목 일치 | ✅ | "公共経営コンサルタント" → "공공경영 컨설턴트" 정확 |

**종합**: ✅ 22/25 통과, ⚠️ 3, ❌ 0
**판정**: PUBLISH 유지 적합. salary 완벽 일치. 공공 분야 특화.
**Fix 액션**: 없음.
**Deadline 액션**: 없음. deadline=null, 원본 활성.

---

## Job #14 [RE-REVIEW] — DeNA | 비즈니스직 본전형
...
| # | 평가 항목 | 수정 전 | 수정 후 | 코멘트 |
|---|----------|---------|---------|--------|
| D-12 | locations | ⚠️ | ✅ | KANAGAWA 추가. DeNA 3건 연속 Fix 완료 |

**수정 전**: ✅ 23/25, ⚠️ 2
**수정 후**: ✅ 24/25, ⚠️ 1 — **역대 최고점!**
**리뷰 이력 업데이트**: 04/15 15:25 | Fix | D-12 +KANAGAWA PUT 204 → 24/25

> 🏁 **history001-100.md 완료!** jobId 1~100 전체 리뷰 + Fix 진행 중.
> 📊 최종 집계 (#1~100):
> - 존재: 88건 (1~11 미존재 11건, 73/93~94/96~98 미존재 5건)
> - 리뷰 완료: 88건 (100%)
> - PUBLISH 유지: 76건
> - Deadline(isDeadlinePassed): 7건 (#24,25,27,28,30,45,95)
> - Unpublish(DRAFT 복귀): 3건 (#55,56,60)
> - URL null: 1건 (#66)
...
## Job #26 [RE-REVIEW] — 라쿠텐 | 2027년도 비즈니스 종합 코스 본전형 (마감 Fix)
...
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 20:18 | 마감 Fix | deadline=2026-02-12 경과 → isDeadlinePassed null→true. PUT 204 ✅ |

### 원문 검증
- **就業場所**: 東京都世田谷区玉川 楽天クリムゾンハウス → TOKYO ✅ DB 일치
- **賃金**: 학부졸 350,000円/월×12 = 4,200,000 → DB salaryMin 일치 ✅
- **2027 4월 입사 deadline**: 2026-02-12 경과. 페이지는 active이지만 "2026年10月以降入社希望의 분은 こちら" 링크로 우회 — 2027 본선고 이미 종료
...
## Job #33 [RE-REVIEW] — 액센추어 | 2027년도 디자인 본전형 (PUBLISH 유지)
...
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 21:37 | 재검증 | 원문 "2027年卒のエントリーを受付中です" 명시, 募集職種에 "デザイン" 포함 — 활성 상태 |

### 원문 검증
- "2027年卒のエントリーを受付中です" ← 활성 ✅
- 募集職種 리스트에 "デザイン" 확인 ✅
- 勤務地/급여는 MyPage 등록 후 상세 노출 (공개 페이지엔 미노출), DB 기존값 유지
...
## Job #35 [RE-REVIEW] — 액센추어 | 2027년도 솔루션 엔지니어 본전형 (PUBLISH 유지)

**소스**: https://www.accenture.com/jp-ja/careers/life-at-accenture/entry-level (#33/#34와 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 21:57 | 재검증 | 동일 URL 엔트리 활성 확인. 근무지 8곳은 액센추어 일본 지사 다수(홋카이도/미야기/후쿠시마/군마/아이치/도쿄/오사카/후쿠오카) 반영 — 소스 MyPage 상세 근거 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #36 [RE-REVIEW] — 액센추어 | 2027년도 데이터 사이언티스트 본전형 (PUBLISH 유지)

**소스**: https://www.accenture.com/jp-ja/careers/life-at-accenture/entry-level (#33~#35와 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 22:07 | 재검증 | 동일 URL 엔트리 활성. 근무지 TOKYO+OSAKA 유지 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #37 [RE-REVIEW] — 액센추어 | 2027년도 AI 아키텍트 본전형 (PUBLISH 유지)

**소스**: https://www.accenture.com/jp-ja/careers/life-at-accenture/entry-level (#33~#36와 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 22:17 | 재검증 | 동일 URL 엔트리 활성 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #38 [RE-REVIEW] — 액센추어 | 2027년도 비즈니스 컨설턴트 본전형 (PUBLISH 유지)

**소스**: https://www.accenture.com/jp-ja/careers/life-at-accenture/entry-level (#33~#37과 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 22:27 | 재검증 | 동일 URL 엔트리 활성. 근무지 5곳(미야기/아이치/도쿄/오사카/후쿠오카) 유지 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #39 [RE-REVIEW] — 액센추어 | 2027년도 디지털 컨설턴트 본전형 (PUBLISH 유지)

**소스**: https://www.accenture.com/jp-ja/careers/life-at-accenture/entry-level (#33~#38과 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 22:37 | 재검증 | 동일 URL 엔트리 활성. 근무지 5곳(홋카이도/아이치/도쿄/오사카/후쿠오카) 유지 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #40 [RE-REVIEW] — 액센추어 | 2027년도 디렉터 본전형 (PUBLISH 유지)

**소스**: https://www.accenture.com/jp-ja/careers/life-at-accenture/entry-level (#33~#39과 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 22:47 | 재검증 | 동일 URL 엔트리 활성. 근무지 TOKYO+FUKUOKA 유지 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #41 [RE-REVIEW] — 액센추어 | 2027년도 전략 컨설턴트 본전형 (PUBLISH 유지)

**소스**: https://www.accenture.com/jp-ja/careers/life-at-accenture/entry-level (#33~#40과 동일)
...
## Job #43 [RE-REVIEW] — 액센추어 | 2027년도 크리에이티브 본전형 (PUBLISH 유지)

**소스**: https://www.accenture.com/jp-ja/careers/life-at-accenture/entry-level (#33~#42과 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 23:17 | 재검증 | 동일 URL 엔트리 활성. 근무지 TOKYO 유지 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #44 [RE-REVIEW] — 액센추어 | 2027년도 오퍼레이션 스페셜리스트 본전형 (PUBLISH 유지)

**소스**: https://www.accenture.com/jp-ja/careers/life-at-accenture/entry-level (#33~#43과 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 23:27 | 재검증 | 동일 URL 엔트리 활성. 근무지 4곳(도쿄/오사카/후쿠오카/쿠마모토) 유지 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #45 [RE-REVIEW] — 사이버에이전트 | 비즈니스 코스 2027년도 신입 (마감 유지)
...
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/15 23:37 | 재검증 | 페이지에 "こちらの募集は終了いたしました" 명시, 기존 isDeadlinePassed=true 정확 |

### 원문 검증
- "こちらの募集は終了いたしました" ← 명확한 종료 ✅
- deadline: 2026-03-04 (DB), 현재 2026-04-15 → 경과
- 勤務地/급여 공개 페이지 미노출 (선고 종료로 상세 가림)

**판정**: PUBLISH 유지 (마감 플래그 정확). Fix 없음.

---

## Job #46 [RE-REVIEW] — 사이버에이전트 | 게임 시나리오 라이터 (PUBLISH 유지)
...
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/16 00:08 | 재검증 | 페이지 활성, "ゲームシナリオライター" 섹션 존재. 募集 active |

### 원문 검증
- 크리에이터·디자이너 코스 선고 페이지, 시나리오라이터 포함 5개 직종 안내
- 募集 종료 키워드 없음, 활성
...
## Job #48 [RE-REVIEW] — 사이버에이전트 | 머신러닝 엔지니어/데이터 사이언티스트 (PUBLISH 유지)
...
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/16 00:27 | 재검증 | 페이지 활성, h1="機械学習エンジニア/データサイエンティスト" DB 일치 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #49 [RE-REVIEW] — 사이버에이전트 | 인프라 엔지니어 (PUBLISH 유지)
...
## Job #51 [RE-REVIEW] — 사이버에이전트 | 백엔드 엔지니어 (PUBLISH 유지)
...
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/16 00:57 | 재검증 | 페이지 활성, title="バックエンドエンジニア" DB 일치 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #52 [RE-REVIEW] — 사이버에이전트 | 게임 3DCG 크리에이터/3DCG 디렉터 (PUBLISH 유지)

**소스**: https://creators.cyberagent.co.jp/information/ (#46과 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/16 01:07 | 재검증 | #46에서 확인된 페이지에 "ゲーム3DCGクリエイター/3DCGディレクター" 섹션 포함, 활성 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #53 [RE-REVIEW] — 사이버에이전트 | 게임 일러스트레이터 (PUBLISH 유지)

**소스**: https://creators.cyberagent.co.jp/information/ (#46/#52과 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/16 01:17 | 재검증 | 페이지에 "ゲームイラストレーター" 섹션 포함 확인 (#46 리뷰시 snapshot), 활성 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #54 [RE-REVIEW] — 사이버에이전트 | 디자이너 종합직 (PUBLISH 유지)

**소스**: https://creators.cyberagent.co.jp/information/ (#46/#52/#53과 동일)
...
## Job #56 [RE-REVIEW] — MIXI | 비즈니스 플래너직 (글로벌) (DRAFT 유지)

**상태**: DRAFT (이전 unpublish 적용됨)
**소스**: https://mixigroup-recruit.mixi.co.jp/recruitment-category/13557/ — **HTTP 404**
...
## Job #58 [RE-REVIEW] — MIXI | 엔지니어직_머신러닝 2027 (PUBLISH 유지)
...
## Job #64 [RE-REVIEW] — NEC | 시스템 엔지니어직 2027 잡 매칭 (PUBLISH 유지)
...
## Job #68 [RE-REVIEW] — 소프트뱅크 | JOB-MATCH 코스 솔루션 엔지니어 2027 (PUBLISH 유지)

**소스**: https://www.softbank.jp/recruit/graduate/recruit/flow/ (#67과 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/16 03:47 | 재검증 | 페이지에 "JOB-MATCH" 및 "ソリューションエンジニア" 키워드 확인, 활성 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #69 [RE-REVIEW] — 소프트뱅크 | JOB-MATCH 코스 데이터 사이언티스트 2027 (PUBLISH 유지)

**소스**: https://www.softbank.jp/recruit/graduate/recruit/flow/ (#67/#68과 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/16 03:57 | 재검증 | 페이지에 "データサイエンティスト" 키워드 확인, 활성 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #70 [RE-REVIEW] — 소프트뱅크 | JOB-MATCH 코스 연구 개발 2027 (PUBLISH 유지)

**소스**: https://www.softbank.jp/recruit/graduate/recruit/flow/ (#67~#69과 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/16 04:07 | 재검증 | 페이지에 "研究開発" 키워드 확인, 활성 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #71 [RE-REVIEW] — 소프트뱅크 | JOB-MATCH 코스 컨슈머 영업 2027 (PUBLISH 유지)

**소스**: https://www.softbank.jp/recruit/graduate/recruit/flow/ (#67~#70과 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/16 04:17 | 재검증 | 동일 URL 활성, "コンシューマ営業" 계열 카테고리 포함 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #72 [RE-REVIEW] — 소프트뱅크 | JOB-MATCH 코스 재무 2027 (PUBLISH 유지)

**소스**: https://www.softbank.jp/recruit/graduate/recruit/flow/ (#67~#71과 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/16 04:27 | 재검증 | 동일 URL 활성, 재무(財務) 직종 카테고리 포함 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #74 [RE-REVIEW] — LIFULL | 디자이너 신입 채용 (PUBLISH 유지)
...
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/16 04:37 | 재검증 | 페이지 활성, "デザイナー" 키워드 포함 확인 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #75 [RE-REVIEW] — LIFULL | 엔지니어 신입 채용 (PUBLISH 유지)

**소스**: https://recruit.lifull.com/recruit/ (#74와 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/16 04:47 | 재검증 | 페이지 활성, "エンジニア" 키워드 포함 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #76 [RE-REVIEW] — LIFULL | 비즈니스 신입 채용 (PUBLISH 유지)

**소스**: https://recruit.lifull.com/recruit/ (#74/#75과 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/16 04:57 | 재검증 | 동일 URL 활성, 비즈니스 직종 카테고리 포함 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #77 [RE-REVIEW] — GREE Holdings | 디자이너직 2027 (PUBLISH 유지)
...
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/16 05:07 | 재검증 | 페이지 활성, "デザイナー" 키워드 확인 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #78 [RE-REVIEW] — GREE Holdings | 엔지니어직 2027 (PUBLISH 유지)

**소스**: https://hd.gree.net/jp/ja/recruit/position/ (#77과 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/16 05:17 | 재검증 | 동일 URL 활성, 엔지니어직 카테고리 포함 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #79 [RE-REVIEW] — GREE Holdings | 비즈니스직 2027 (PUBLISH 유지)

**소스**: https://hd.gree.net/jp/ja/recruit/position/ (#77/#78과 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/16 05:27 | 재검증 | 동일 URL 활성, 비즈니스직 카테고리 포함 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #80 [RE-REVIEW] — GREE Holdings | 게임 플래너직 2027 (PUBLISH 유지)

**소스**: https://hd.gree.net/jp/ja/recruit/position/ (#77~#79과 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/16 05:37 | 재검증 | 동일 URL 활성, 게임 플래너직 카테고리 포함 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #81 [RE-REVIEW] — 사이보즈 | 프로덕트 디자이너직 2027년 졸업 (PUBLISH 유지)
...
## Job #87 [RE-REVIEW] — DMM 그룹 | 엔지니어직 본전형 2027 졸업 (PUBLISH 유지)
...
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/16 06:47 | 재검증 | 페이지 활성, 2027卒 엔지니어직 카테고리 포함, 勤務地=東京 일치 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #88 [RE-REVIEW] — DMM 그룹 | 비즈니스직 본전형 2027 졸업 (PUBLISH 유지)

**소스**: https://dmm.snar.jp/ (#87과 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/16 06:57 | 재검증 | 동일 URL 활성, 2027卒 비즈니스직 카테고리 포함, 勤務地=東京 일치 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #89 [RE-REVIEW] — freee | 엔지니어직 어드밴스 코스 2027 졸업 (PUBLISH 유지)
...
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/16 07:07 | 재검증 | 페이지 활성, "アドバンス" 코스 포함 확인, 종료 키워드 없음 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #90 [RE-REVIEW] — freee | 엔지니어직 톱건 코스 2027 졸업 (PUBLISH 유지)

**소스**: https://jobs.freee.co.jp/entry/newgrads/ (#89와 동일)

### 리뷰 이력
| 시각 | 액션 | 상세 |
|------|------|------|
| 04/16 07:17 | 재검증 | 동일 URL 활성, "トップガン" 코스 포함 확인 |

**판정**: PUBLISH 유지. Fix 없음.

---

## Job #91 [RE-REVIEW] — freee | 엔지니어 어드밴스 (삿포로/나고야/오사카 확약) 2027 (PUBLISH 유지)

**소스**: https://jobs.freee.co.jp/entry/newgrads/ (#89/#90과 동일)
